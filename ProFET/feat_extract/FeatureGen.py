  ...
  ExtraScaleWindow=17,
   ...
   split_N=False,split_C=False,N_TAIL_REGION=30,C_TAIL_REGION=30
    ...
    if split_C is True: #Slice out end of seq
        ...
        C_protein = ProtFeat(C_seq, HAS_N=False, HAS_C=True)
    ...
    main_protein = ProtFeat(main_seq, HAS_N=(not (split_N)),HAS_C=(not (split_C)))
...
def get_reduced_prot(seq,alph_name="ofer14"):
  ...
  reduced_protein = ProtFeat(ProteinSequence=red_seq,alph_letters=alph_name)
...
import param as params #What is Params ??? #Dan.
